...
// Paddle_OnIce - deaccelerates the paddle by 10 for 90 seconds
public class Paddle_OnIce extends PowerUp { // Removes 90% deceleration for 90 seconds
    // Constructor
    public Paddle_OnIce(Line line) {
        super(line);
    }
        ...
        if (Collider instanceof Paddle) {
            ...
            for (int i = 0; i < paddles.size(); i
                ...
                paddles.get(i).setDeccelerationX(
                        paddles.get(i).getDeccelerationX() / 10);
            }
